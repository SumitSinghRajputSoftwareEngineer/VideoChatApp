...
import conf from "../assests/conf.jpg";
  ...
  return (
    <div className="">
      ...
      <div className="relative  h-screen">
        ...
        {/*Hero Info*/}
        <div className="flex lg:pt-20 flex-col items-center justify-center relative z-10 px-6 md:max-w-[90vw] mx-auto">
            {/*Main*/}
            <div className="lg:flex flex-col items-center justify-center pd-8">
          ...
          >
            <div className="flex flex-col justify-center items-center">
              <label className="text-[30px] md:text-[40px] font-bold pt-6" htmlFor="">Enter The Room Code</label>
              <input
                type="text"
                required
                name=""
              ...
              <button type="submit" className="bg-blue-500 hover:bg-blue-400 duration-100 font-bold w-[5rem] md:w-[7rem] rounded-full py-[5px] md:py-[7px] mt-2 md:mt-4 ">Go</button>
          </form>
        </div>
      </div>
    </div>
